...
# ----- Full layout -----
layout = [
    [sg.Text("Link"), sg.In(size=(32, 1), enable_events=True,
                            key="-LINK-"), sg.Button("OK")],
...
window = sg.Window("Light Novel Crawler", layout,
                    element_justification='c', location=(600, 200))
...
while True:
    ...
    if event == "OK":
        ...
        image_url = re.findall(r, html_soup.select(
            IMAGE_SELECTOR)[0].attrs['style'])[0]
